<?php
// HTTP
define('HTTP_SERVER', 'http://localhost/jackielingerie/admin/');
define('HTTP_CATALOG', 'http://localhost/jackielingerie/');

// HTTPS
define('HTTPS_SERVER', 'http://localhost/jackielingerie/admin/');
