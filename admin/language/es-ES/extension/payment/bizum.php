...
*/
$_['heading_title']		= 'Bizum';
 
// Text
$_['text_payment']		= 'Payment';
$_['text_success']		= 'Success: Ha modificado correctamente el sistema Bizum!';
$_['text_bizum']       = '<a href="http://www.redsys.es" target="_blank"><img src="view/image/extension/payment/Bizum.png" style="border: 1px solid #EEEEEE;" /></a>';
...
// Entry
$_['entry_entorno']	 = 'Entorno de Bizum:';
...
// Error
$_['error_permission']	= 'Warning: No tienes permisos para modificar Bizum!';
